"""
Django settings for calm_snowflake_dev_67084 project.
...
ROOT_URLCONF = 'calm_snowflake_dev_67084.urls'
...
WSGI_APPLICATION = 'calm_snowflake_dev_67084.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_snowflake_dev_67084 API",
    "DESCRIPTION": "API documentation for calm_snowflake_dev_67084 App",
    "VERSION": "v1",
}
